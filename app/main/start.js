angular.module('quickGoFeApp').controller('StartCtrl', function ($scope, $log, basketService, $location, filteringService, $sce) {
  ...
  $scope.termsTooltip = $sce.trustAsHtml('<strong>Search for Terms</strong><p>Use this section to directly search for terms using a Quick GO ID, or by using more generic search terms to select from a drop down list or result screen.');
